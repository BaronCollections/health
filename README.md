...
- 当前账户中心能力：统一 `/profile` 入口、通知中心分类流、消息详情页、批量已读、旧 `/pricing` 入口兼容跳转
- 当前帮助反馈能力：帮助中心 FAQ、支持联系入口、反馈表单、反馈记录状态分组与回复展示
- 当前社区能力：推荐 feed、发帖、帖子详情、评论、我的帖子、审核状态、运营审核列表页
- 当前账户中心进展：`平台级账户中心节点开发中`，已完成 `/profile` 统一入口壳层、通知中心与帮助反馈，下一步进入隐私与数据控制
